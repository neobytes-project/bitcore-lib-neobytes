...
describe('Networks', function() {
  ...
  it('will enable/disable regtest Network', function() {
    ...
    networks.testnet.port.should.equal(12437);
    ...
    networks.testnet.port.should.equal(12427);
    networks.testnet.dnsSeeds.should.deep.equal([
     'testnet-seed.neobytes.tools'
    ]);
  });
  ...
  it('can test for multiple keys', function() {
    expect(networks.get(0x70, ['pubkeyhash', 'scripthash'])).to.equal(networks.testnet);
    expect(networks.get(0x12, ['pubkeyhash', 'scripthash'])).to.equal(networks.testnet);
